...
/*   Updated: 2024/04/04 17:41:38 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int philos_init(t_table *table)
{
    ...
    i = 0;
    printf("philo %d\n", i);
    printf("table BEFORE->philos[i].id = %d\n", table->philos[i].id);
    printf("table BEFORE->philos[i].meal_counter = %ld\n", table->philos[i].meal_counter);
    printf("table BEFORE->philos[i].last_meal_time = %ld\n", table->philos[i].last_meal_time);
    printf("table BEFORE->philos[i].is_full = %d\n", table->philos[i].is_full);
    while(i+1 < table->n_philos)
    {
