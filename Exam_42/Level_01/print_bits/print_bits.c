...
int main(int argc, char **argv)
{
    if (argc == 2) {
        ...
        unsigned char octet = (unsigned char)num;  // Asegurarse de que el número esté en el rango de un unsigned char
        print_bits(octet);  // Llamar a la función para imprimir los bits
